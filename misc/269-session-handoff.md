# Continue the Second Brain requirements review
...
3. [PRD-creator draft](SKILL%20(2).md), the revised skill template on this branch.
...
- The edited PRD-creator draft and this handoff belong to branch `issue-269-second-brain-design`. Preserve that draft when updating the branch. It is not yet a packaged skill or merged toolkit change.
...
Fetch this branch, open its worktree in the preferred editor, and read the
