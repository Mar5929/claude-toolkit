...
List the destinations the current project's AGENTS.md and rules declare for design output. Do not assume a folder structure; discover it per Phase 2 of the skill. Typical destinations:
