...
| File | What it does |
|---|---|
| `delivery-and-knowledge-boundary.md` | Owns the Salesforce delivery-root choice and nothing else. New projects use `delivery/`; existing `engagement/` projects stay in place. |
