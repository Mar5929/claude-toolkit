...
writing the prompt, invoke that skill and let it follow `knowledge/README.md`.
...
review gets skipped, because once the prompt is on screen the session is over in
the owner's head.
