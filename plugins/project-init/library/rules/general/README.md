...
| File | What it does |
|---|---|
| `where-persistent-information-belongs.md` | Put active work wherever its work item is tracked, agent instructions in rules, reusable processes in skills, approved behavior in specifications, and persistent project information in memory. Uses short approval bullets and prevents copies. |
