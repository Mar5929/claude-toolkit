---
name: drawio
description: Generate draw.io diagrams as .drawio files, optionally export to PNG/SVG/PDF with embedded XML. Use this skill whenever the user asks to create a diagram, flowchart, architecture diagram, ER diagram, sequence diagram, network topology, org chart, or any visual diagram using draw.io. Also trigger when the user mentions .drawio files, wants to visualize systems or processes as draw.io diagrams, asks to export diagrams to PNG/SVG/PDF, or says "draw", "diagram", or "flowchart" in the context of creating a draw.io file. Do NOT use for Excalidraw diagrams or Mermaid-only output.
