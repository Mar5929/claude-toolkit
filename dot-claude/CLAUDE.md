...
When developing UI features, agents must follow an iterative screenshot loop:
...
This is not optional. Every UI change must be visually verified via screenshot before being considered complete. Do not rely solely on code review — actually look at the rendered output in the browser and iterate until it looks right.
