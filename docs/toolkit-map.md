...
| work | work-tracker | Offer and resume goal-scoped agent-led delivery in the chosen tracker, then, where the host supports other chats, ask after acceptance how the team is arranged: one team in this chat, or a Main Orchestrator chat coordinating other chats; manage local work items, roadmaps, execution tasks, current-task continuation, linked children, grouping, archives, and safe conversion in Git-ignored folders | `/work`, "add this to the backlog", "what should I work on next?" |
