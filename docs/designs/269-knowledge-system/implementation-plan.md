...
Live status is not kept here. The transfer events, the running chats with
their session ids, and the main's next actions are in
[#269](https://github.com/Mar5929/claude-toolkit/issues/269) under
"Claude pickup, 2026-09-21".
