...
| R18 entry (a), line 141 | The SG PRD gives the guide "`knowledge/system/` with `README.md`, `tour.md`, and eight section folders" | `knowledge/prds/toolkit-operating-system/system-guide.md` lines 195-204 list seven section folders: `business/`, `data-model/`, `objects/`, `fields/`, `processes/`, `relationships/`, `applications/` | Seven section folders, plus `README.md` and `tour.md`. The path conflict itself is real and correctly reported |
...
| R16 entry, line 125 | "The tracker's Done event is the nearest documented moment (`work-item-upkeep.md` line 543)" | `knowledge/prds/toolkit-operating-system/work-item-upkeep.md` is 60 lines long. Line 543 does not exist. Done is defined at lines 40-44; "Project knowledge may react to completion and link back to the item" is line 53 | The tracker's Done event is `work-item-upkeep.md` lines 40-44, and line 53 is the sentence that permits knowledge to react to completion |
...
8. **The System Guide path conflict.** The knowledge PRD's layout gives the
   ...
   (`knowledge/prds/toolkit-operating-system/system-guide.md` lines 195-204), and allows an existing
...
9. **The glossary path conflict.** The knowledge PRD names
   ...
   (`knowledge/prds/toolkit-operating-system/system-guide.md` line 125). Both were opened. One must win.
...
PRD: `/home/user/claude-toolkit/knowledge/prds/toolkit-operating-system/knowledge-system.md`.
