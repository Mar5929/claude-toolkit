...
claude-toolkit/
  ...
  plugins/
    ...
    protocol-guard/               ← plugin: required workflow checks (Claude Code only)
      ...
      protocols.default.json      ← the shipped list: K4, CW, K5, K6
