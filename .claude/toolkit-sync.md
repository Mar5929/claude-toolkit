...
its detailed Toolkit manual. Second-brain 4.11.0 supplies ordered read pointers
instead of full document bodies and repairs aliased hook entry paths. This is
not a full project-sync run or proof of another project's adoption. Actual host
evidence and remaining limits are in the
[manual delivery review](../docs/designs/306-toolkit-manual-review.md#implementation-and-verification).
