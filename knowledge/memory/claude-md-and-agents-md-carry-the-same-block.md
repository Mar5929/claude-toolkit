---
summary: AGENTS.md holds a word for word copy of the shared instruction block in CLAUDE.md rather than pointing at it, because Codex cannot follow a pointer.
type: decision
status: current
source: Mike, deciding it on 2026-08-04 while setting this repository up with its own toolkit for GitHub issue #138
confidence: reported
created_at: 2026-08-06
tags: [root-instructions, codex, claude-md, agents-md]
...
- [what goes in a folder instruction file](../specs/folder-instruction-files.md):
