---
summary: Only Mar5929 may push this repository; the work account has no access, and a push login window previously meant Git had switched accounts.
group: Git publication
context: After main pushes failed with Invalid username or token and repeatedly opened a login window on 2026-09-09.
