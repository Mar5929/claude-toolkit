...
**Authority:** This file is the current approved v2 memory-system specification. Approval covers its design meaning, not an automatic implementation or migration.
